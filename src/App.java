...
class MainPanel extends JPanel implements ActionListener {
  ...
  class Highscores extends JPanel {
    ...
    Highscores() {
      ...
      setBackground(Color.BLACK);
      backButton = createButton("BACK", getMAX_X() / 2 - 200, getMAX_Y() / 2 + 250);
      scoresArea = createTextArea("1. Player A: 1000\n2. Player B: 900\n3. Player C: 800", getMAX_X() / 2 - 300, getMAX_Y() / 2 - 100);
      this.add(backButton);
      this.add(scoresArea);
    }
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (source == menu.menuButtons[3]) System.exit(0);
    if (source == menu.menuButtons[0]) cl.show(this, "Play");
    if (source == menu.menuButtons[1]) cl.show(this, "Instructions");
    if (source == menu.menuButtons[2]) cl.show(this, "Highscores");
    if (source == play.modeButtons[2] || source == instructions.backButton || source == highscores.backButton) cl.first(this);
  }
}
